      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center space-x-6">
          ...
          <div className="relative profile-area">
            ...
            {showProfileMenu && (
              <div
                className="profile-dropdown fixed top-[4rem] right-[1rem] sm:right-[1.5rem] w-56 rounded-xl shadow-2xl py-2 z-[9999]
                border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 animate-dropdownFade"
              >
                {/* small arrow below AU */}
